...
class ChatBot  {
  ...
  // <textarea class="textarea-content p-absolute" placeholder="Message ask" id="input-ask"></textarea>
  //  <input class="textarea-content p-absolute" placeholder="Message ask" id="input-ask">
  loadControlUI() {
    return `
  ...
  async sendMessageToBot(message) {
    try {
      ...
      this.appendMessageToChat('Error sending message:', error); 
    }
  }
